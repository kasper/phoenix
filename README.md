...
- Current version: 2.6.4 ([Changelog](CHANGELOG.md))
...
- [**Download Phoenix**](https://github.com/kasper/phoenix/releases/download/2.6.4/phoenix-2.6.4.tar.gz)
...
- [JavaScript API](https://github.com/kasper/phoenix/blob/2.6.4/docs/API.md) (current)
...
7. [Node.js](https://nodejs.org) (14.4.0 or higher)
