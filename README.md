...
- Current version: 2.6.6 ([Changelog](CHANGELOG.md))
...
- [**Download Phoenix**](https://github.com/kasper/phoenix/releases/download/2.6.6/phoenix-2.6.6.tar.gz)
...
- [JavaScript API](https://github.com/kasper/phoenix/blob/2.6.6/docs/API.md) (current)
...
4. [Ruby](https://www.ruby-lang.org) (2.7.2 or higher), it is recommended that you manage Ruby versions with for instance [rbenv](https://github.com/rbenv/rbenv/)
...
7. [Node.js](https://nodejs.org) (15.12.0 or higher)
