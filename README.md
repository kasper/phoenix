...
- Current version: 2.2.1 ([Changelog](CHANGELOG.md))
...
- [**Download Phoenix**](https://github.com/kasper/phoenix/releases/download/2.2.1/phoenix-2.2.1.tar.gz)
...
- [JavaScript API](https://github.com/kasper/phoenix/blob/2.2.1/API.md) (current)
...
7. [Node.js](https://nodejs.org) (6.3.0 or higher)
