...
- Current version: 2.6 ([Changelog](CHANGELOG.md))
...
- [**Download Phoenix**](https://github.com/kasper/phoenix/releases/download/2.6/phoenix-2.6.tar.gz)
...
- [JavaScript API](https://github.com/kasper/phoenix/blob/2.6/docs/API.md) (current)
...
7. [Node.js](https://nodejs.org) (9.10.1 or higher)
