...
- Current version: 2.2 ([Changelog](CHANGELOG.md))
...
- [**Download Phoenix**](https://github.com/kasper/phoenix/releases/download/2.2/phoenix-2.2.tar.gz)
...
- [JavaScript API](https://github.com/kasper/phoenix/blob/2.2/API.md) (current)
