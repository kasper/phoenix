...
Screen.prototype.frameInRectangle = function () {
  Phoenix.log('Deprecated: Function Screen#frameInRectangle() is deprecated and will be removed in later versions, use Screen#flippedFrame() instead.');
...
Screen.prototype.visibleFrameInRectangle = function () {
  Phoenix.log('Deprecated: Function Screen#visibleFrameInRectangle() is deprecated and will be removed in later versions, use Screen#flippedVisibleFrame() instead.');
